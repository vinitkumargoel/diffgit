...
/**
 * `git hash-object -t tree /dev/null` — the tree every repository implicitly has (T10.1).
 * A root commit is diffed against it, and a `RangeSource` with `fromOid: null` means "this tree".
 */
